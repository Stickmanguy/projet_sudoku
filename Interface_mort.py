...
class Mort:
    ...
    def __init__(self, identifiant):
        ...
        self.sudoku_01 = sudoku_ori.data
        self.sudoku_un = sudoku_ori.data
        self.nbr = 0
        self.window = Tk()
        self.y = 0
        self.x = 0
        ...
        self.btn_supp = Button(text="Effacer", width=6, font=("Helvetica", 15), relief=FLAT, command=lambda: self.chiffre_selected(0))
        self.btn_supp.place(x=357, y=530)

        self.btn_exit = Button(text="Quitter", width=6, font=("Helvetica", 15), relief=FLAT,command=lambda: self.exit())
        ...
        for ligne in range(0, 9):
            for col in range(0, 9):
                if self.sudoku_01.data[ligne, col] != 0:
                    lc = ligne * 9 + col
